!function() {
    ...
    w.import = function(e, t) {
        ...
        return Promise.resolve(n.prepareImport()).then((function() {
            ...
            return t.C || function(e, t) {
                return t.C = O(e, t, t, {}).then((function() {
                    return x(e, t, {})
                }
                )).then((function() {
                    return t.n
    ...
    w.createScript = function(e) {
        ...
        t.async = !0,
        e.indexOf(I + "/") && (t.crossOrigin = "anonymous");
        var n = M.integrity[e];
    ...
    w.resolve = function(n, r) {
        return d(M, a(n, r = r || t) || n, r) || function(t, n) {
    ...
    var $ = "undefined" != typeof Symbol && Symbol.toStringTag;
    w.get = function(e) {
        var t = this[m][e];
        if (t && null === t.e && !t.E)
    ...
    w.set = function(e, t) {
        var n;
        $ && "Module" === t[$] ? n = t : (n = Object.assign(Object.create(null), t),
